...
-- Internal signals
--
signal half_addsub : std_logic_vector(31 downto 0);
signal full_addsub : std_logic_vector(31 downto 0);
signal carry_chain : std_logic_vector(30 downto 0);
--
begin
  ...
  begin
     ...
     mid_carry: if i>0 and i<31 generate
	  begin
