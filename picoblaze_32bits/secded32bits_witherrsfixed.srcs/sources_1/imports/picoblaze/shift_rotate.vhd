...
begin
  ...
  --
	shift_in_bit <= (inject_bit and code1 and code0)
					 ...
					 or (operand(31) and (not code1) and code0 and shift_right)
					 or (operand(31) and code1 and (not code0) and (not shift_right))
  ...
  --
  mux_output <= (shift_in_bit & operand(31 downto 1)) when shift_right = '1'
  				else (operand(30 downto 0) & shift_in_bit);

  bus_width_loop: for i in 0 to 31 generate
  begin
  ...
  --
  	...
  	carry_bit <= (shift_right and operand(0))
				or ((not shift_right) and operand(31));
